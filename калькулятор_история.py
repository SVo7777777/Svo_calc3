...
history_layout1 = Button(text='[b]история продаж[/b]', font_size=22, size_hint=(2, 1), markup=True)
...
def  remove_all(t):
    ...
    if t == True:
        ...
        history_layout1.text = 'показать калькулятор'
        lay0.size_hint=(1, .0319)
        cl_all= False        
    else:      
       ...
       layout0.add_widget(root)
       layout0.add_widget(layout1)
       history_layout1.text = 'история продаж'
       lay0.size_hint=(1, .13)
       cl_all = True   
         
def setka_history(i1, i2):
    for i in range(i1, i2):
        ...
        layout_history.add_widget(h_layout)
